...
class EmpruntControllerTest {
    ...
    void doitRetournerUnEmprunt() {
        ...
        var resp = restTemplate.patchForObject(
                "/api/emprunts/" + empruntId + "/retourner", null, Map.class);
    ...
    void doitSignalerRetard() {
        ...
        var resp = restTemplate.patchForObject(
                "/api/emprunts/" + empruntId + "/retard", null, Map.class);
    ...
    void doitDeclarerPerte() {
        ...
        var resp = restTemplate.patchForObject(
                "/api/emprunts/" + empruntId + "/perte", null, Map.class);
    ...
    void doitRetourner409SiExemplaireIndisponible() {
        ...
        var resp = restTemplate.postForEntity("/api/emprunts",
                Map.of("exemplaireId", exId), Map.class);
    ...
    void doitRetourner404SiEmpruntInexistant() {
        var resp = restTemplate.patchForObject(
                "/api/emprunts/99999/retourner", null, Map.class);
    ...
    private Long creerEmpruntComplet(String titre, String cote) {
        ...
        var emprunt = restTemplate.postForEntity("/api/emprunts",
                Map.of("exemplaireId", exId), Map.class);
