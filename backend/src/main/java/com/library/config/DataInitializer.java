...
public class DataInitializer {
  ...
  @Bean
  CommandLineRunner seedFakeLivres(OuvrageRepository ouvrageRepository) {
    return args -> {
      ...
      ouvrageRepository.saveAll(
          List.of(
              createLivre("Le Nom de la Rose", "Polar historique", "Umberto Eco", 9782264027757L, 1980, 12),
              createLivre("Dune", "Science-fiction", "Frank Herbert", 9782266151580L, 1965, 15),
              createLivre("Clean Code", "Informatique", "Robert C. Martin", 9780132350884L, 2008, 20),
              createLivre("Le Petit Prince", "Conte", "Antoine de Saint-Exupéry", 9782070612758L, 1943, 8),
              createLivre("L'Appel de Cthulhu", "Horreur", "H. P. Lovecraft", 9782253002029L, 1928, 10)));
    };
  }
