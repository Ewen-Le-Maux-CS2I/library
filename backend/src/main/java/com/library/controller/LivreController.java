...
public class LivreController {
    ...
    /**
     * GET /api/livres                  — liste tous les ouvrages
     * GET /api/livres?titre=dune       — recherche par titre (insensible à la casse)
     * GET /api/livres?genre=Roman      — recherche par genre exact
     */
    @GetMapping
    ...
    public Ouvrage getLivre(@PathVariable Long id) {
        return bibliotheque.trouverOuvrage(id)
                .orElseThrow(() -> new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Livre introuvable"));
    }
